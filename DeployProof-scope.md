...
*Package: `deployproof` (v1.1.0 on PyPI). Repository: github.com/SVSPraveen/DeployProof. Status: Released September 1, 2026.*
...
|---|---|---|
| **Phase 1** | **Python Core (v1.1.0)** | Native AST mutation engine, Git diff cascading, credential scanner, GhostApproval symlinks, slopsquatting age detector. |
