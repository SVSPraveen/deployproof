...
| **Version** | `deployproof --version` | Displays the current installed version of DeployProof. | Displays `deployproof 1.1.17` |
...
|---|---|---|---|
| `--output <path>` | `-o` | Custom file path to save the full verification report (e.g. `-o scan.txt`). Automatically defaults to `.deployproof/report.txt`. | `.deployproof/report.txt` |
| `--suggest-tests` | | Print auto-synthesized test suggestions inline for surviving mutants in terminal report. | Disabled by default |
